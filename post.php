    ...
    <div class="collection">
        ...
        <div class="gallery">
            ...
            <div class="gallery-detail">
                ...
                <div class="line">
                    <span class="middle"><i class="material-icons-outlined tv">tv</i>
                        TV(<?php echo $post['episodes']; ?>eps)</span>
        ...
        <div class="comments">
            <div class="write-comment">
                <form action="" id="comment-form">
                    <textarea placeholder="Leave a comment....." name="comment" id="comment_Text" cols="30"
                        rows="10"></textarea>
